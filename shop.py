    ...
    def shop_management(self):
        if self.opened_shop_window:
            ...
            for index, item in enumerate(player_items):
                ...
                item.draw(pygame.display.get_surface(), (pos_x, pos_y))
                ...
                sell_rects.append(pygame.Rect(pos_x, pos_y, self.game.settings.tile_size * 2,
            ...
            for index, item in enumerate(shopkeeper_items):
                ...
                buy_rects.append(pygame.Rect(pos_x, pos_y, self.game.settings.tile_size * 2,
                                             self.game.settings.tile_size * 2))
